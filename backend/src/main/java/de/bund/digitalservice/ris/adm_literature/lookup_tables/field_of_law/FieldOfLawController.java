...
public class FieldOfLawController {
  ...
  public ResponseEntity<FieldOfLawResponse> getFieldsOfLawParents() {
    return ResponseEntity.ok(new FieldOfLawResponse(fieldOfLawService.findFieldsOfLawParents()));
  }
  ...
  public ResponseEntity<FieldOfLawResponse> getFieldsOfLawChildren(
    ...
    return ResponseEntity.ok(
      new FieldOfLawResponse(fieldOfLawService.findFieldsOfLawChildren(identifier))
    );
  }
  ...
  public FieldOfLawQueryResponse findFieldsOfLaw(
    ...
    var paginatedFieldsOfLaw = fieldOfLawService.findFieldsOfLaw(
      new FieldOfLawQuery(
