...
class FieldOfLawControllerTest {
  ...
  void getFieldsOfLaw() throws Exception {
    // given
    given(fieldOfLawService.findFieldsOfLawChildren("PR-01")).willReturn(
      List.of(
        new FieldOfLaw(
          UUID.randomUUID(),
          false,
  ...
  void getFieldsOfLawParents() throws Exception {
    // given
    given(fieldOfLawService.findFieldsOfLawParents()).willReturn(
      List.of(
        new FieldOfLaw(
          UUID.randomUUID(),
          false,
  ...
  void getTreeForFieldOfLaw() throws Exception {
    // given
    given(fieldOfLawService.findFieldOfLaw("AR")).willReturn(
      Optional.of(
        new FieldOfLaw(
          UUID.randomUUID(),
          false,
  ...
  void getTreeForFieldOfLaw_notFound() throws Exception {
    // given
    given(fieldOfLawService.findFieldOfLaw("BR-123456")).willReturn(Optional.empty());
  ...
  void findFieldsOfLaw() throws Exception {
    ...
    given(fieldOfLawService.findFieldsOfLaw(query)).willReturn(
      TestPage.create(
        List.of(
          new FieldOfLaw(
            UUID.randomUUID(),
