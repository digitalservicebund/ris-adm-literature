...
class JaxbXmlWriterTest {

  private JaxbXmlWriter jaxbXmlWriter;

  @BeforeEach
  void beforeEach() throws JAXBException {
    jaxbXmlWriter = new JaxbXmlWriter(JAXBContext.newInstance(AkomaNtoso.class, JaxbHtml.class));
  }
  ...
  void writeXml() {
    ...
    // when
    String xml = jaxbXmlWriter.writeXml(akomaNtoso);
  ...
  void writeXml_withoutXmlHeader() {
    ...
    // when
    String xml = jaxbXmlWriter.writeXml(akomaNtoso, false);
  ...
  void writeXml_exceptionDueToNonRootElement() {
    ...
    // when
    Exception exception = catchException(() -> jaxbXmlWriter.writeXml(doc));
