...
import de.bund.digitalservice.ris.adm_literature.application.DocumentationUnitQuery;
...
class DocumentationUnitPersistenceServiceTest {
  ...
  void findDocumentationUnitOverviewElements() {
    ...
    // when
    de.bund.digitalservice.ris.adm_literature.application.Page<
      DocumentationUnitOverviewElement
    > result = documentationUnitPersistenceService.findDocumentationUnitOverviewElements(
