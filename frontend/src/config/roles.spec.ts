...
describe('Role Configuration', () => {
  ...
  it('should map roles to the correct home route names', () => {
    expect(roleToHomeRouteMap[USER_ROLES.VWV_USER]).toBe(ROUTE_NAMES.VWV.START_PAGE)
    expect(roleToHomeRouteMap[USER_ROLES.LIT_BAG_USER]).toBe(ROUTE_NAMES.ULI.START_PAGE)
  })
