...
import {
  createEmptyNormSettingAuthority,
  type NormSettingAuthority,
} from '@/domain/normSettingAuthority'
...
const buttonLabel = computed(() =>
  authorities.value.length > 0 ? 'Weitere Angabe' : 'Normgeber hinzufügen',
)
</script>
