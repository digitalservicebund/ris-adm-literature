...
import AbgabePage from '@/views/Abgabe.view.vue'
import AdmRubriken from '@/views/adm/documentUnit/[documentNumber]/Rubriken.view.vue'
import FundstellenPage from '@/views/adm/documentUnit/[documentNumber]/Fundstellen.view.vue'
